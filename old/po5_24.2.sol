...
//     EventLogger public eventLoggerManager;
...
//      */
//     constructor(address _eventLoggerManager, address _showroomAddress, address _balancesAddress, address _rootNode, address _daoNode, address _stockNode, address _usdtAddress) {
...
//         eventLoggerManager = EventLogger(_eventLoggerManager);
...
//                 abi.encodePacked(
//                     "withdrawBP failed: last balance: ", lastBalance.toString(),
//                     ", pre balance: ", preBalance.toString(),
...
//     // *
//     // * @title Generation Rank Update for MLM System
...
//     function updateGenerationRank(address current) internal {
...
//                       ", currentRank: ", uint256(currentRank).toString()
//                   )
//               );
...
//         address[] memory children = nodes[current].children;
//         for (uint i = 0; i < children.length; i++) {
//             updateGenerationRank(children[i]);
//         }
//     }
