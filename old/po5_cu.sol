...
//      */
//     constructor(address _eventLoggerAddress, address _showroomAddress, address _balancesAddress, address[] memory _rootMembers, address[] memory _daoMembers, address _usdtAddress) {
...
//          return (rootNode, daoNode, stockNode);
//     }
...
//     }
//     function getInfoVIPNode() external onlyEOA view returns (VIPNode memory, NodeData memory) {
//         // chỉ cho phép ViewTree gọi
//         // require(msg.sender == viewTreeContract, "Unauthorized caller");
//         address user = msg.sender;
//         require(vipNodes[user].parent != address(0), "User does not exist");
//         return (vipNodes[user],nodeData[user]);
//     }
