...
contract BalancesManager is Ownable {
    ...
    function withdrawUltraBPExternal(
        address user,
        bytes32 utxoID
    ) external onlyOwner {
        withdrawUltraBP(user, utxoID);
    }
...
contract TreeCommission is ITreeCommission {
    ...
    function addVIPMember(address newMember, address parent, bytes32 utxoID) external onlyEOA {
        ...
        // console.log("eComUserManager.getUserParent(newMember):",eComUserManager.getUserParent(newMember));
